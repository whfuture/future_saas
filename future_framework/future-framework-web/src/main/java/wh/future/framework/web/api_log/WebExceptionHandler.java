...
//    }
    ...
    private void createExceptionLog(HttpServletRequest req, Throwable e) {
        ...
        try {
            ...
            log.error("[createExceptionLog][url({}) api_log({}) 发生异常]", req.getRequestURI(),  JsonUtil.toJsonString(errorLog), th);
        }
    }
...
//            api_log.error("[报表模块 yudao-module-report - 表结构未导入][参考 https://cloud.iocoder.cn/report/ 开启]");
