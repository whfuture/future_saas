...
import wh.future.framework.api.internal.logger.ApiAccessLogApi;
...
import static wh.future.framework.web.log.AccessLogInterceptor.ATTRIBUTE_HANDLER_METHOD;
...
public class ApiAccessLogFilter extends OncePerRequestFilter {
    ...
    private void doCreateApiAccessLog(HttpServletRequest request, LocalDateTime beginTime,
        ...
        try {
            ...
            log.error("[createApiAccessLog][url({}) log({}) 发生异常]", request.getRequestURI(), JsonUtil.toJsonString(accessLog), th);
        }
    }
